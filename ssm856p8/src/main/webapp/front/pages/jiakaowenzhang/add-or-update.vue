	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`jiakaowenzhang`, this.ruleForm.id);
...
//跨表计算判断
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`jiakaowenzhang`, this.ruleForm);
						}else{
							await this.$api.add(`jiakaowenzhang`, this.ruleForm);
						}
