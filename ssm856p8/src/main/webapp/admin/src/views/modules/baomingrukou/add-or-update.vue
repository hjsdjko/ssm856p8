    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="驾照类型" prop="jiazhaoleixing">
          <el-select :disabled="ro.jiazhaoleixing" v-model="ruleForm.jiazhaoleixing" placeholder="请选择驾照类型">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="费用说明" prop="feiyongshuoming">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.feiyongshuoming" label="费用说明" prop="feiyongshuoming">
                    <span>{{ruleForm.feiyongshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
		...
		if(json.jiaxiaodizhi!=''&&json.jiaxiaodizhi){
                this.ruleForm.jiaxiaodizhi = json.jiaxiaodizhi
	    		this.ro.jiaxiaodizhi = true;
		}
		if(json.tupian!=''&&json.tupian){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/jiazhaoleixing/jiazhaoleixing`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.jiazhaoleixingOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
