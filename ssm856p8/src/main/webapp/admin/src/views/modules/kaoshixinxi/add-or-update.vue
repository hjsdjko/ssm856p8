<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考试场地" prop="kaoshichangdi">
          <el-select :disabled="ro.kaoshichangdi" v-model="ruleForm.kaoshichangdi" placeholder="请选择考试场地">
            <el-option
                v-for="(item,index) in kaoshichangdiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="考试日期" prop="kaoshiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaoshiriqi" label="考试日期" prop="kaoshiriqi">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="考试场次" prop="kaoshichangci">
          <el-select :disabled="ro.kaoshichangci" v-model="ruleForm.kaoshichangci" placeholder="请选择考试场次">
            <el-option
                v-for="(item,index) in kaoshichangciOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="考试内容" prop="kaoshineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="考试内容"
                  v-model="ruleForm.kaoshineirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.kaoshineirong" label="考试内容" prop="kaoshineirong">
                    <span>{{ruleForm.kaoshineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jiaxiaozhanghao!=''&&json.jiaxiaozhanghao){
                this.ruleForm.jiaxiaozhanghao = json.jiaxiaozhanghao
	    		this.ro.jiaxiaozhanghao = true;
		}
		if(json.jiaxiaomingcheng!=''&&json.jiaxiaomingcheng){
                this.ruleForm.jiaxiaomingcheng = json.jiaxiaomingcheng
	    		this.ro.jiaxiaomingcheng = true;
		}
        } else {
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/kaoshichangdi/kaoshichangdi`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.kaoshichangdiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/kaoshichangci/kaoshichangci`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.kaoshichangciOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
